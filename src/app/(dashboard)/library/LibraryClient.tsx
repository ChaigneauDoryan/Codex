...
const getStatusDetails = (statusId: number) => {
  switch (statusId) {
    ...
    default: return { name: 'unknown', label: 'Inconnu', bgColorClass: 'bg-gray-500' }; // Fallback
  }
};
            ...
            <Card key={userBook.id} className="flex flex-col">
              <CardHeader>
                <CardTitle className="flex justify-between items-start">
                  ...
                  {isCurrentlyArchived && (
                    <span className="text-xs bg-muted text-muted-foreground px-2 py-1 rounded">Archivé</span>
                  )}
                </CardTitle>
